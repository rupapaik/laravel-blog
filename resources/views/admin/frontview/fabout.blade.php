      ...
      <div class="menu_block">
        <nav>
          <ul class="sf-menu">
            ...
            <li class="current"><a href="{{URL::to('abouts')}}">About Us</a></li>
...
<div class="page1_block nb">
  <div class="container_12">
    <div class="grid_7">
      <h2>What we do</h2>
      <br>
      <img src="{{asset('front')}}/images/page2_img1.jpg" alt="" class="img_inner fleft i1">
...
<div class="content">
  <div class="container_12">
    ...
    <div class="clear"></div>
    <div class="grid_4">
      <div class="pad2"> <img src="{{asset('front')}}/images/page2_img2.jpg" alt="" class="img_inner fleft i2">
        <div class="extra_wrapper">
    ...
    <div class="grid_4">
      <div class="pad2"> <img src="{{asset('front')}}/images/page2_img3.jpg" alt="" class="img_inner fleft i2">
        <div class="extra_wrapper">
    ...
    <div class="grid_4">
      <div class="pad2"> <img src="{{asset('front')}}/images/page2_img4.jpg" alt="" class="img_inner fleft i2">
        <div class="extra_wrapper">
    ...
    <div class="grid_4">
      <div class="pad2"> <img src="{{asset('front')}}/images/page2_img5.jpg" alt="" class="img_inner fleft i2">
        <div class="extra_wrapper">
    ...
    <div class="grid_4">
      <div class="pad2"> <img src="{{asset('front')}}/images/page2_img6.jpg" alt="" class="img_inner fleft i2">
        <div class="extra_wrapper">
    ...
    <div class="grid_4">
      <div class="pad2"><img src="{{asset('front')}}/images/page2_img7.jpg" alt="" class="img_inner fleft i2">
        <div class="extra_wrapper">
...
<div class="bottom_block bot1">
  <div class="container_12">
    ...
    <div class="grid_4">
      <div class="pad2"> <img src="{{asset('front')}}/images/page2_img8.jpg" alt="" class="img_inner fleft">
        <div class="extra_wrapper">
    ...
    <div class="grid_4">
      <div class="pad2"> <img src="{{asset('front')}}/images/page2_img9.jpg" alt="" class="img_inner fleft">
        <div class="extra_wrapper">
    ...
    <div class="grid_4">
      <div class="pad2"> <img src="{{asset('front')}}/images/page2_img10.jpg" alt="" class="img_inner fleft">
        <div class="extra_wrapper">
