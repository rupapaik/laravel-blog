...
<div class="content pt1">
  <div class="container_12">
    <div class="grid_7">
      <h2>Blog</h2>
      <br>
      <div class="blog"> <img src="{{asset('front')}}/images/page4_img1.jpg" alt="" class="img_inner fleft i1">
      ...
      <div class="blog"> <img src="{{asset('front')}}/images/page4_img2.jpg" alt="" class="img_inner fleft i1">
        <div class="extra_wrapper">
        ...
        <a href="#" class="btn">More</a> </div>
      <div class="blog"> <img src="{{asset('front')}}/images/page4_img3.jpg" alt="" class="img_inner fleft i1">
        <div class="extra_wrapper">
        ...
        <a href="#" class="btn">More</a> </div>
      <div class="blog"> <img src="{{asset('front')}}/images/page4_img4.jpg" alt="" class="img_inner fleft i1">
        <div class="extra_wrapper">
